...
{
    [UsedImplicitly]
    internal sealed class RotationInputController : IStartGameListener, IUpdateGameListener
    {
        ...
        internal RotationInputController(InputFacade input, Camera camera, Transform transform, IAtomicObject rotatable)
        {
            _input = input;
            _camera = camera;
